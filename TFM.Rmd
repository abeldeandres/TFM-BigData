...
* A continuaci髇 vamos a aunar todas las variables del escaner. Si un paciente ha sido transferido a otro hospital y se han realizado los escaneres, entonces, se mantendran los ultimos valores del escaner. En caso contrario, se usaran los primeros resultados de escaner obtenidos. Adem醩, eliminaremos todas las variables que no se utilicen.
