...
* Como se puede comprobar, el error OOB, se estabiliza, indicando cuantas particiones se deben realizar para obtener los mejores resultados En este caso, con 4 variables seria suficiente (puesto que es el numero donde se estabiliza el error OOB).
