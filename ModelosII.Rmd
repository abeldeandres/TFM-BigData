...
#final$outcome<-ifelse(final$outcome == "1", "F", "V")
...
confusionMatrixCV<-confusionMatrix(data = predCV, reference = test$outcome,positive="1")
confusionMatrixCV
```
...
confusionMatrixAdaBoost<-confusionMatrix(data=as.factor(adaboost.predict$class),reference=test$outcome,positive="1")
