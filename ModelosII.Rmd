...
time <- system.time(model.LR <- caret::train(outcome~.,data = train, method="glm", family="binomial",trControl = ctrl, tuneLength = 5,metric="ROC"))
...
plot.roc(test$outcome, pred.LR$F,          # data
...
plot.roc(test$outcome, pred.LR$F,
         percent = TRUE, 
         add = TRUE, 
...
plot.roc(test$outcome, pred.LR1$F,          # data
         percent = TRUE,                    # show all values in percent
         partial.auc=c(100, 90), 
         partial.auc.correct=TRUE,          # define a partial AUC (pAUC)
         print.auc=TRUE,                    
...
plot.roc(test$outcome, pred.LR1$F,
         percent = TRUE, 
         add = TRUE, 
         type = "n",                        # add to plot, but don't re-add the ROC itself (useless)
         partial.auc = c(100, 90), 
...
plot.roc(test$outcome, pred.NB2$F,          # data
         percent = TRUE,                    # show all values in percent
         partial.auc=c(100, 90), 
         partial.auc.correct=TRUE,          # define a partial AUC (pAUC)
         print.auc=TRUE,                    
...
plot.roc(test$outcome, pred.NB2$V,
         percent = TRUE, 
         add = TRUE, 
         type = "n",                        # add to plot, but don't re-add the ROC itself (useless)
         partial.auc = c(100, 90), 
...
plot.roc(test$outcome, pred.RF2$F,          # data
         percent = TRUE,                    # show all values in percent
         partial.auc=c(100, 90), 
         partial.auc.correct=TRUE,          # define a partial AUC (pAUC)
         print.auc=TRUE,                    
...
plot.roc(test$outcome, pred.RF2$V,
         percent = TRUE, 
         add = TRUE, 
         type = "n",                        # add to plot, but don't re-add the ROC itself (useless)
         partial.auc = c(100, 90), 
...
plot.roc(test$outcome, pred.ada2$F,          # data
         percent = TRUE,                    # show all values in percent
         partial.auc=c(100, 90), 
         partial.auc.correct=TRUE,          # define a partial AUC (pAUC)
         print.auc=TRUE,                    
...
plot.roc(test$outcome, pred.ada2$V,
         percent = TRUE, 
         add = TRUE, 
         type = "n",                        # add to plot, but don't re-add the ROC itself (useless)
         partial.auc = c(100, 90), 
...
time<-system.time(modelGBM <- caret::train(outcome~., data=train, method="gbm",distribution="bernoulli",metric=metric, trControl=fitControl, verbose=F ))
arrayTiemposTrain<-c(arrayTiemposTrain, as.numeric(time[3]))
print(modelGBM)
```
...
```{r , echo=FALSE}
timePred<-system.time(pred.GBM <- predict(modelGBM, test, na.action = na.pass))
arrayTiemposPredict<-c(arrayTiemposPredict, as.numeric(timePred[3]))
...
plot.roc(test$outcome,pred.GBM2$F,          # data
         percent = TRUE,                    # show all values in percent
         partial.auc=c(100, 90), 
         partial.auc.correct=TRUE,          # define a partial AUC (pAUC)
         print.auc=TRUE,                    
...
plot.roc(test$outcome, pred.GBM2$F,
         percent = TRUE, 
         add = TRUE, 
         type = "n",                        # add to plot, but don't re-add the ROC itself (useless)
         partial.auc = c(100, 90), 
...
plot.roc(test$outcome,pred.XGB2$F,          # data
         percent = TRUE,                    # show all values in percent
         partial.auc=c(100, 90), 
         partial.auc.correct=TRUE,          # define a partial AUC (pAUC)
         print.auc=TRUE,                    
...
plot.roc(test$outcome, pred.XGB2$F,
         percent = TRUE, 
         add = TRUE, 
         type = "n",                        # add to plot, but don't re-add the ROC itself (useless)
         partial.auc = c(100, 90), 
...
nameVectorConf<-c("NN","NN2","XGBoost","GBM","Adaboost","R Forest","N.BAYES","RLog_Comp","RLog_13")
...
```{r , echo=FALSE}
nameVectorTime<-c("GLM","NB","RF","Adaboost","GBM","XGBoost","R.Neuronal")
...
text(arrayTiemposTrain, TimeArrStr, labels=arrayTiemposTrain, cex= 0.7, pos=3)
legend(x= "center", y="bottom", # places a legend at the appropriate place 
...
model_preds <- lapply(model_preds, function(x) x[,"F"])
model_preds <- data.frame(model_preds)
ens_preds <- predict(greedy_ensemble, newdata=test, type="prob")
model_preds$ensemble <- ens_preds
caTools::colAUC(model_preds, test$outcome)
```

```{r , echo=FALSE}
gbmImp  <-varImp(greedy_ensemble)
gbmImp 
```
...
```{r , echo=FALSE}
pred.GBM.ensemble <- predict(stack.gbm, test, na.action = na.pass)
confusionMatrixGBM<-caret::confusionMatrix(data=pred.GBM.ensemble,reference=test$outcome,positive="F")
confusionMatrixGBM
```
* ELiminamos ada y glm
...
confusionMatrixGBM<-caret::confusionMatrix(data=pred.GBM.ensemble,reference=test$outcome)
confusionMatrixGBM
```