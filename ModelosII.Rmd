...
```{r , echo=FALSE}
plot.roc(test$outcome, pred,          # data
...
* A continuacion, vamos a utilizar la curva de ROC con los valores de pAUC:
```{r , echo=FALSE}
plot.roc(test$outcome, pred2,          # data
         percent = TRUE,                    # show all values in percent
         partial.auc=c(100, 90), 
         partial.auc.correct=TRUE,          # define a partial AUC (pAUC)
         print.auc=TRUE,                    
...
```{r , echo=FALSE}
adaboost.predict <- predict(adaboost, newdata = test, type="prob")
...
plot.roc(test$outcome,model.predictGBM,          # data
         percent = TRUE,                    # show all values in percent
         partial.auc=c(100, 90), 
         partial.auc.correct=TRUE,          # define a partial AUC (pAUC)
         print.auc=TRUE,                    
...
plot.roc(test$outcome, model.predictGBM,
         percent = TRUE, 
         add = TRUE, 
         type = "n",                        # add to plot, but don't re-add the ROC itself (useless)
         partial.auc = c(100, 90), 
